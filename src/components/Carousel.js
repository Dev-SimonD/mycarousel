     ...
     <>
       ...
       >
         ...
         <img src={Man}
          ...
          <h2 className="text-start blueText py-3">nezaměstnanost v červenci vzrostla na 3,3%</h2>
         ...
         <img src={Couple}
          ...
          <h2 className="text-start blueText py-3">Čechům záleží na příjemné pracovní atmosféře více než před 5 lety</h2>
          <p className="text-start blueText">V našem průzkumu Randstad Employer Brand Research jsme letos již popáté porovnávali faktory, které ovlivňují pracovníky při výběru zaměstnavatele.</p>
          <div className="d-flex">
          <button type="button" class="btn p-3 btn-outline-primary">Prectete si vice</button>
          </div>
           </div>
         ...
         <img src={Fun}
          ...
          <h2 className="text-start blueText py-3">tři pětiny Čechů jsou otevřeny změně práce</h2>
