  ...
  <div className='divider'></div>
    ...
    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
      ...
      <ul>
            ...
            <p className='container pt-3' style={{"color":"#6b718a", "fontSize":"0.75rem"}}>Randstad HR Solutions s.r.o., 
                IČ 08025851, DIČ CZ08025851 zapsaná v obchodním rejstříku vedeném
                 Městským soudem v Praze, spisová značka C 311763.
Sídlo společnosti se nachází na adrese Praha 1, Nové Město,
 Jungmannova 26/15, tel.: 222 210 013
RANDSTAD, home, HUMAN FORWARD a SHAPING THE WORLD
 OF WORK registrované obchodní značky ve vlastnictví Randstad N.V.</p>
 <p className='container pt-3' style={{"color":"#6b718a"}}>© Randstad N.V. 2021. Všechna práva vyhrazena.</p>
